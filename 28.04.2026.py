...
while True:
    ...
    if linesP is not None:
        for i in range(0, len(linesP)):
            ...
            #cv2.circle(cdstP, (x1, y1), 10, (255, 0, 0), 3)
            #cv2.circle(cdstP, (x2, y2), 10, (0, 255, 0), 3)
            cv2.circle(cdstP, (cx, cy), 10, (255, 255, 255), 3)
    ...
    if (len(leftPoints) != 0) and (len(rightPoints) != 0):
        leftTapeX = np.mean(leftPoints)
        rightTapeX = np.mean(rightPoints)
